...
static int cmd_Options(SSL_CONF_CTX *cctx, const char *value)
{
    static const ssl_flag_tbl ssl_option_list[] = {
        ...
        SSL_FLAG_TBL_INV("CertificateCompression", SSL_OP_NO_CERTIFICATE_COMPRESSION)
    };
    if (value == NULL)
        return -3;
...
static const ssl_conf_cmd_tbl ssl_conf_cmds[] = {
    ...
    SSL_CONF_CMD_SWITCH("no_cert_comp", 0),
    SSL_CONF_CMD_SWITCH("cert_comp", 0),
...
static const ssl_switch_tbl ssl_cmd_switches[] = {
    ...
    {SSL_OP_NO_CERTIFICATE_COMPRESSION, 0}, /* no_cert_comp */
    {SSL_OP_NO_CERTIFICATE_COMPRESSION, SSL_TFLAG_INV}, /* cert_comp */
