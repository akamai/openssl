...
$proxy->clientflags("-no_cert_comp -sess_out ".$session);
$proxy->serverflags("-no_cert_comp -servername localhost");
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -sess_in ".$session);
...
#        key_share
$proxy->clear();
$proxy->clientflags("-no_cert_comp -allow_no_dhe_kex -sess_in ".$session);
$proxy->serverflags("-no_cert_comp -allow_no_dhe_kex");
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -sess_in ".$session);
$proxy->serverflags("-no_cert_comp -curves P-256");
$testtype = BOTH_KEX_MODES;
$proxy->start();
...
#         key_share
$proxy->clear();
$proxy->clientflags("-no_cert_comp -allow_no_dhe_kex -curves P-384 -sess_in ".$session);
$proxy->serverflags("-no_cert_comp -allow_no_dhe_kex -curves P-256");
$testtype = BOTH_KEX_MODES;
$proxy->start();
checkhandshake($proxy, checkhandshake::RESUME_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -curves P-384 -sess_in ".$session);
$proxy->serverflags("-no_cert_comp -curves P-256");
$testtype = DHE_KEX_MODE_ONLY;
$proxy->start();
